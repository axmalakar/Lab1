...
REM
REM Generated by Vivado on Wed Feb 21 16:30:10 -0600 2024
...
echo "xvlog --incr --relax -prj top_demo_vlog.prj"
call xvlog  --incr --relax -prj top_demo_vlog.prj -log xvlog.log
